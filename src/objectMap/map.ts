...
export function addMap<TVal>(map: IMap<TVal>, array: TVal[], key: stringSelector<TVal>): IMap<TVal>;
export function addMap<TVal>(map: INumberMap<TVal>, array: TVal[], key: numberSelector<TVal>): INumberMap<TVal>;
export function addMap<TSrc, TVal>(map: IMap<TVal>, array: TSrc[], key: stringSelector<TSrc>, val: selector<TSrc, TVal>): IMap<TVal>;
export function addMap<TSrc, TVal>(map: INumberMap<TVal>, array: TSrc[], key: numberSelector<TSrc>, val: selector<TSrc, TVal>): INumberMap<TVal>;
export function addMap<TSrc, TVal>(
  map: IMap<TVal>,
  array: TSrc[],
  keySelector: stringSelector<TSrc> | numberSelector<TSrc>,
  valSelector?: selector<TSrc, TVal>): IMap<TVal> | INumberMap<TVal> {
